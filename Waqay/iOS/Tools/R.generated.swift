...
struct R: Rswift.Validatable {
  ...
  struct storyboard {
    ...
    /// Storyboard `PushPermission`.
    static let pushPermission = _R.storyboard.pushPermission()
    /// Storyboard `Welcome`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIStoryboard(name: "PushPermission", bundle: ...)`
    static func pushPermission(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.pushPermission)
    }
    #endif
  ...
  struct entitlements {
    ...
    struct comAppleSecurityApplicationGroups {
      static let groupComProatomicdevWaqayOnesignal = infoPlistString(path: ["com.apple.security.application-groups"], key: "group.com.proatomicdev.Waqay.onesignal") ?? "group.com.proatomicdev.Waqay.onesignal"
  ...
  struct string {
    ...
    struct addRadioStations {
      ...
      static func title(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("title", tableName: "AddRadioStations", bundle: hostingBundle, comment: "")
        }
        ...
        return NSLocalizedString("title", tableName: "AddRadioStations", bundle: bundle, comment: "")
      }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    #if os(iOS) || os(tvOS)
    struct pushPermission: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = PushPermissionViewController

      let bundle = R.hostingBundle
      let name = "PushPermission"
